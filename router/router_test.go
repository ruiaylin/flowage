...
import (
	...
	"github.com/ruiaylin/flowage/utils/yaml"
	"testing"
)
...
`
	...
	hashRule := rt.GetRule("flowage_test_shard_hash")
	...
	rangeRule := rt.GetRule("flowage_test_shard_range")
	...
	defaultRule := rt.GetRule("flowage_defaultRule_table")
	if defaultRule == nil {
