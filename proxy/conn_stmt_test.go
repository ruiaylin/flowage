...
func TestStmt_DropTable(t *testing.T) {
	...
	c.UseDB("flowage")
	if _, err := c.Execute(`drop table if exists flowage_test_proxy_stmt`); err != nil {
		t.Fatal(err)
	}
	c.Close()
}
...
func TestStmt_CreateTable(t *testing.T) {
	str := `CREATE TABLE IF NOT EXISTS flowage_test_proxy_stmt (
...
func TestStmt_Insert(t *testing.T) {
	str := `insert into flowage_test_proxy_stmt (id, str, f, e, u, i) values (?, ?, ?, ?, ?, ?)`
...
func TestStmt_Select(t *testing.T) {
	str := `select str, f, e from flowage_test_proxy_stmt where id = ?`
...
func TestStmt_NULL(t *testing.T) {
	str := `insert into flowage_test_proxy_stmt (id, str, f, e) values (?, ?, ?, ?)`
	...
	str = `select * from flowage_test_proxy_stmt where id = ?`
	s, err = c.Prepare(str)
...
func TestStmt_Unsigned(t *testing.T) {
	str := `insert into flowage_test_proxy_stmt (id, u) values (?, ?)`
	...
	str = `select u from flowage_test_proxy_stmt where id = ?`
...
func TestStmt_Signed(t *testing.T) {
	str := `insert into flowage_test_proxy_stmt (id, i) values (?, ?)`
...
func TestStmt_Trans(t *testing.T) {
	...
	if _, err := c1.Execute(`insert into flowage_test_proxy_stmt (id, str) values (1002, "abc")`); err != nil {
		t.Fatal(err)
	}
	...
	str := `select str from flowage_test_proxy_stmt where id = ?`
